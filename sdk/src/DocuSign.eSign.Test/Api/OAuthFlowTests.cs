...
//            ////NUnit.Framework.Assert.IsNotNull(loginInfo.ApiPassword);
//            //NUnit.Framework.Assert.IsNotNull(loginInfo.LoginAccounts);
//            //NUnit.Framework.Assert.IsTrue(loginInfo.LoginAccounts.Count > 0);
//            //NUnit.Framework.Assert.IsTrue(!String.IsNullOrWhiteSpace(loginInfo.LoginAccounts[0].AccountId));
